...
def helper_wbb_pbp(game_id, pbp_txt):
    gameSpread, overUnder, homeFavorite, gameSpreadAvailable = helper_wbb_pickcenter(pbp_txt)
    pbp_txt['timeouts'] = {}

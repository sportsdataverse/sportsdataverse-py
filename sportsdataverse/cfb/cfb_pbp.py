...
# The ESPN team-box helpers are shared with the NFL processor; the private
# names stay importable here for existing callers.
from sportsdataverse.football.attribution import (  # noqa: E402
    _abbr_compat,
    _parse_recovery_abbrev,  # noqa: F401  (re-exported for tests)
    _parse_recovery_abbrevs,
    _strip_overturned_text,  # noqa: F401  (re-exported for tests)
...
from sportsdataverse.football.box import air_yards_box as _air_yards_box  # noqa: E402
from sportsdataverse.football.box import _ordered_rows  # noqa: E402
...
class CFBPlayProcess(object):
    ...
    def __setup_penalty_data(self, play_df):
        ...
        play_df = (
            ...
            .pipe(_add_penalty_enforcement_cols)
            .with_columns(
    ...
    def __add_attribution_cols(self, play_df):
        """Resolve the credited team per play (shared football attribution, CFB text parsers)."""
        return _add_attribution_cols(
            play_df,
            parse_recovery_abbrevs=_parse_recovery_abbrevs,
            parse_penalty_team_side=_parse_penalty_team_side,
            parse_penalty_spot=_parse_penalty_spot,
        )
    ...
    def create_box_score(self, play_df):
        ...
        defensive_players_json = _build_defensive_players_box(play_df)
        specialists_json = _build_specialists_box(play_df)
    ...
    def __join_participants(self, play_df):
        ...
        try:
            ...
            if parts is None or parts.height == 0 or "id" not in play_df.columns:
                ...
                return play_df
            return _coalesce_participants(play_df, parts)

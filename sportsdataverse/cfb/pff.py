"""PFF Premium Stats -- NCAA (college football) league shim over :mod:`sportsdataverse.nfl.pff_core`.

Exposes the generated ``pff_*`` wrappers with ``league="ncaa"`` pre-bound. See the

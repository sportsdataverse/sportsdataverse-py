...
def espn_cfb_season_week_powerindex(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    ...
    **kwargs,
    ...
    Example URL: https://sports.core.api.espn.com/v2/sports/football/leagues/college-football/seasons/2024/types/2/weeks/8/powerindex
    ...
    _params.update(_caller_params)
    raw = _get(
        f"https://sports.core.api.espn.com/v2/sports/football/leagues/college-football/seasons/{season}/types/{season_type}/weeks/{week}/powerindex",
        params=_params,
        **kwargs,
    )
    if return_parsed:

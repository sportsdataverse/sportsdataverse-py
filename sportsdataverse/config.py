...
CFB_ROSTER_URL = (
    SGITHUB + "cfbfastR-data/main/rosters/parquet/cfb_rosters_{season}.parquet"
)
CFB_TEAM_LOGO_URL = SGITHUB + "cfbfastR-data/main/teams/teams_colors_logos.parquet"
CFB_TEAM_SCHEDULE_URL = (
    SGITHUB + "cfbfastR-data/main/schedules/parquet/cfb_schedules_{season}.parquet"
)
CFB_TEAM_INFO_URL = (
    SGITHUB + "cfbfastR-data/main/team_info/parquet/cfb_team_info_{season}.parquet"
)

NHL_BASE_URL = (
    SGITHUB + "fastRhockey-data/main/nhl/pbp/parquet/play_by_play_{season}.parquet"
)
NHL_PLAYER_BOX_URL = (
    SGITHUB + "fastRhockey-data/main/nhl/player_box/parquet/player_box_{season}.parquet"
)
NHL_TEAM_BOX_URL = (
    SGITHUB + "fastRhockey-data/main/nhl/team_box/parquet/team_box_{season}.parquet"
)
NHL_TEAM_SCHEDULE_URL = (
    SGITHUB
    + "fastRhockey-data/main/nhl/schedules/parquet/nhl_schedule_{season}.parquet"
)
NHL_TEAM_LOGO_URL = SGITHUB + "fastRhockey-data/main/nhl/nhl_teams_colors_logos.csv"

PHF_BASE_URL = (
    SGITHUB + "fastRhockey-data/main/phf/pbp/parquet/play_by_play_{season}.parquet"
)
PHF_PLAYER_BOX_URL = (
    SGITHUB + "fastRhockey-data/main/phf/player_box/parquet/player_box_{season}.parquet"
)
PHF_TEAM_BOX_URL = (
    SGITHUB + "fastRhockey-data/main/phf/team_box/parquet/team_box_{season}.parquet"
)
PHF_TEAM_SCHEDULE_URL = (
    SGITHUB
    + "fastRhockey-data/main/phf/schedules/parquet/phf_schedule_{season}.parquet"
)

MBB_BASE_URL = (
    SDVRELEASES + "espn_mens_college_basketball_pbp/play_by_play_{season}.parquet"
)
MBB_TEAM_BOX_URL = (
    SDVRELEASES
...
MBB_TEAM_SCHEDULE_URL = (
    SDVRELEASES + "espn_mens_college_basketball_schedules/mbb_schedule_{season}.parquet"
)
...
NBA_PLAYER_BOX_URL = (
    SDVRELEASES + "espn_nba_player_boxscores/player_box_{season}.parquet"
)
NBA_TEAM_SCHEDULE_URL = SDVRELEASES + "espn_nba_schedules/nba_schedule_{season}.parquet"

WBB_BASE_URL = (
    SDVRELEASES + "espn_womens_college_basketball_pbp/play_by_play_{season}.parquet"
)
WBB_TEAM_BOX_URL = (
    SDVRELEASES
    + "espn_womens_college_basketball_team_boxscores/team_box_{season}.parquet"
)
WBB_PLAYER_BOX_URL = (
    SDVRELEASES
...
WBB_TEAM_SCHEDULE_URL = (
    SDVRELEASES
    + "espn_womens_college_basketball_schedules/wbb_schedule_{season}.parquet"
)
...
WNBA_PLAYER_BOX_URL = (
    SDVRELEASES + "espn_wnba_player_boxscores/player_box_{season}.parquet"
)
WNBA_TEAM_SCHEDULE_URL = (
    SDVRELEASES + "espn_wnba_schedules/wnba_schedule_{season}.parquet"
)
...
NFL_WEEKLY_ROSTER_URL = (
    NFLVERSEGITHUB + "weekly_rosters/roster_weekly_{season}.parquet"
)  # done
NFL_SNAP_COUNTS_URL = NFLVERSEGITHUB + "snap_counts/snap_counts_{season}.parquet"
NFL_PBP_PARTICIPATION_URL = (
    NFLVERSEGITHUB + "pbp_participation/pbp_participation_{season}.parquet"
)
...
NFL_TEAM_SCHEDULE_URL = (
    NFLVERSEGITHUBPBP + "nflverse-pbp/master/schedules/sched_{season}.rds"
)

"""ESPN NFL athlete *season* stats scraper (core-v2).
...
graph. For the richer web-v3 payload use
:func:`sportsdataverse.nfl.espn_nfl_player_stats_v3`.
"""
...
def espn_nfl_player_stats(
    ...
    **kwargs: Any,
    ...
    Args:
        athlete_id: ESPN NFL athlete identifier (e.g. ``3139477`` for
            Patrick Mahomes).

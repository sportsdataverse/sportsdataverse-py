...
def espn_nfl_schedule(dates=None, week=None, season_type=None, groups=None, limit=500,
...
def espn_nfl_calendar(season = None, ondays = None,
...
def __ondays_nfl_calendar(season, **kwargs):
    ...
    if resp is not None:
        ...
        result = result.with_columns(
            url="http://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?dates="
            + pl.col('dateURL')
        )

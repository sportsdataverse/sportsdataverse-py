...
def espn_wnba_schedule(dates=None, season_type=None, limit=500) -> pd.DataFrame:
    ...
    url = "http://site.api.espn.com/apis/site/v2/sports/basketball/wnba/scoreboard?limit={}{}{}".format(
...
def espn_wnba_calendar(season=None, ondays=None) -> pd.DataFrame:
    ...
    if ondays is not None:
        url = "https://sports.core.api.espn.com/v2/sports/basketball/leagues/wnba/seasons/{}/types/2/calendar/ondays".format(
            season
        )
        resp = download(url=url)
        ...
        full_schedule["url"] = (
            "http://site.api.espn.com/apis/site/v2/sports/basketball/wnba/scoreboard?dates="
        )
        full_schedule["url"] = full_schedule["url"] + full_schedule["dateURL"]
    else:
        url = "http://site.api.espn.com/apis/site/v2/sports/basketball/wnba/scoreboard?dates={}".format(
            season
        )
        resp = download(url=url)

...
def espn_wnba_schedule(dates=None, season_type=None, limit = 500,
...
def espn_wnba_calendar(season=None, ondays=None,
                       return_as_pandas = True, **kwargs) -> pd.DataFrame:
    ...
    if ondays is not None:
        ...
        full_schedule = full_schedule.with_columns(
            url="http://site.api.espn.com/apis/site/v2/sports/basketball/wnba/scoreboard?dates=" +
                pl.col('dateURL')
        )

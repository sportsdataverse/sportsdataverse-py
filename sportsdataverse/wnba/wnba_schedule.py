...
def espn_wnba_schedule(dates=None, season_type=None, limit=500, return_as_pandas=True, **kwargs) -> pd.DataFrame:
...
def espn_wnba_calendar(season=None, ondays=None, return_as_pandas=True, **kwargs) -> pd.DataFrame:

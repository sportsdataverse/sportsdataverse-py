...
def espn_wnba_game_rosters(game_id: int, raw = False, return_as_pandas = True, **kwargs) -> pd.DataFrame:
    ...
    summary_url = "https://sports.core.api.espn.com/v2/sports/basketball/leagues/wnba/events/{x}/competitions/{x}/competitors".format(x=game_id)

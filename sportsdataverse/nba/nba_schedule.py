...
def espn_nba_schedule(dates=None, season_type=None, limit=500) -> pd.DataFrame:
    ...
    url = "http://site.api.espn.com/apis/site/v2/sports/basketball/nba/scoreboard?limit={}{}{}".format(
...
def espn_nba_calendar(season=None, ondays=None) -> pd.DataFrame:
    ...
    if ondays is not None:
        url = "https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/{}/types/2/calendar/ondays".format(
            season
        )
        resp = download(url=url)
        ...
        url = "http://site.api.espn.com/apis/site/v2/sports/basketball/nba/scoreboard?dates={}".format(
            season
        )
        resp = download(url=url)

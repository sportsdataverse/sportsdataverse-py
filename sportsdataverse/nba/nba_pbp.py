...
def espn_nba_pbp(game_id: int, raw=False) -> Dict:
    ...
    summary_url = "http://site.api.espn.com/apis/site/v2/sports/basketball/nba/summary?event={}".format(
        game_id
    )
...
def helper_nba_pbp(game_id, pbp_txt):
    gameSpread, overUnder, homeFavorite, gameSpreadAvailable = helper_nba_pickcenter(
        pbp_txt
    )
    pbp_txt["timeouts"] = {}

...
Registers ``espn_nba_*`` wrappers via :func:`sportsdataverse._common_espn.make_league_module`.
...
__all__ = make_league_module("basketball", "nba", "nba", globals(), include_ncaa=False, include_football=False)

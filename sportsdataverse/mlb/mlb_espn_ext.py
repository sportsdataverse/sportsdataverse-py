...
def espn_mlb_season_week_powerindex(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    ...
    **kwargs,
    ...
    Example URL: https://sports.core.api.espn.com/v2/sports/baseball/leagues/mlb/seasons/2024/types/2/weeks/8/powerindex
...
def espn_mlb_season_week_games(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    limit: Optional[int] = 500,

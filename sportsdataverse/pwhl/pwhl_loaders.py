...
# Reciprocal naming-parity aliases (load_pwhl_*_box -> load_pwhl_*_boxscores,
# load_pwhl_schedule -> load_pwhl_schedules) and load_pwhl_games() are
# hand-maintained below the generated section.

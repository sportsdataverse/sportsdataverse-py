---
title: "NFL tutorial"
description: "NFL walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`nfl_standings`](../reference/index.qmd) | Team standings for a season/week — one row per team | 🟢 premium (NFL.com) |
| [`nfl_rosters`](../reference/index.qmd) | Season rosters, one row per team (players nested) | 🟢 premium (NFL.com) |
| [`nfl_injuries`](../reference/index.qmd) | Weekly injury report, one row per player | 🟢 premium (NFL.com) |
| [`nfl_weeks`](../reference/index.qmd) | The week calendar (bye weeks, date ranges) | 🟢 premium (NFL.com) |
| [`nfl_weekly_game_details`](../reference/index.qmd) | Rich per-game details for a week (drive charts, standings) | 🟢 premium (NFL.com) |
| [`nfl_game_summaries`](../reference/index.qmd) | Live game state, one row per game | 🟢 premium (NFL.com) |
| [`nfl_team`](../reference/index.qmd) | Single-team detail by `team_id` | 🟢 premium (NFL.com) |
| [`nfl_ngs_statboard`](../reference/index.qmd) | NextGen Stats season leaderboard (passing/rushing/receiving) | 🟢 premium (NextGen Stats) |
| [`nfl_ngs_leaders`](../reference/index.qmd) | NextGen top-N highlight boards (speed, YAC over expected, …) | 🟢 premium (NextGen Stats) |
| [`nfl_ngs_league_schedule`](../reference/index.qmd) | NextGen schedule — source of NGS `gameId`s | 🟢 premium (NextGen Stats) |
| [`nfl_ngs_gamecenter_overview`](../reference/index.qmd) | Per-game NextGen player splits (passers/rushers/…) | 🟢 premium (NextGen Stats) |
| [`load_nfl_pbp`](../reference/index.qmd) | Full nflfastR play-by-play (370+ columns) | 📦 nflverse release |
| [`load_nfl_player_stats`](../reference/index.qmd) | Weekly player box-score stats | 📦 nflverse release |
| [`load_nfl_nextgen_stats`](../reference/index.qmd) | NextGen Stats back to 2016 (release parquet) | 📦 nflverse release |
| [`load_nfl_rosters`](../reference/index.qmd) | Season rosters with IDs & bios | 📦 nflverse release |
| [`espn_nfl_schedule`](../reference/index.qmd) · [`espn_nfl_scoreboard`](../reference/index.qmd) | ESPN scoreboard/schedule (no auth) | 🔵 ESPN (secondary) |
| [`load_nfl_snap_counts`](../reference/index.qmd) | Weekly snap counts & snap-share % per player | 📦 nflverse release |
| [`load_nfl_depth_charts`](../reference/index.qmd) | Weekly depth charts, one row per slotted player | 📦 nflverse release |
| [`load_nfl_schedule`](../reference/index.qmd) | Game results + lines, one row per game | 📦 nflverse release |
| [`load_nfl_draft_picks`](../reference/index.qmd) | Every draft pick + career value, one row per pick | 📦 nflverse release |
...
The headliner. [`nfl_standings`](../reference/index.qmd)
...
[`nfl_rosters`](../reference/index.qmd) gives one row per
team for a season, with the player list nested under `persons` (great for a
team directory). [`nfl_weeks`](../reference/index.qmd) is the
...
|---|---|---|
| [`nfl_rosters`](../reference/index.qmd) | team | `team_abbreviation`, `team_conference_abbr`, `persons` |
| [`nfl_weeks`](../reference/index.qmd) | week | `week`, `week_type`, `bye_teams`, `date_begin` |
...
[`nfl_injuries`](../reference/index.qmd) is the official
...
[`nfl_weekly_game_details`](../reference/index.qmd)
...
flags), reach for
[`nfl_game_summaries`](../reference/index.qmd).
...
[`nfl_ngs_statboard`](../reference/index.qmd) is the
...
And [`nfl_ngs_leaders`](../reference/index.qmd)
...
|---|---|---|
| [`load_nfl_pbp`](../reference/index.qmd) | ~49k/season | EPA, WP, air yards, 370+ columns |
| [`load_nfl_player_stats`](../reference/index.qmd) | weekly | passing/rushing/receiving box lines |
| [`load_nfl_nextgen_stats`](../reference/index.qmd) | weekly | NGS back to 2016 |
| [`load_nfl_rosters`](../reference/index.qmd) | per player | IDs, bios, draft info |
...
there. [`espn_nfl_schedule`](../reference/index.qmd)
returns a tidy schedule frame; pass `dates=YYYYMMDD` for a single day. (There's
also a raw [`espn_nfl_scoreboard`](../reference/index.qmd)
...
[`nfl_ngs_gamecenter_overview`](../reference/index.qmd)
...
Roll the weekly box scores in [`load_nfl_player_stats`](../reference/index.qmd) up to season totals and crown the ground-game kings (≥150 carries).
...
Expected points added is the modeller's favourite efficiency yardstick. Average `epa` over every run/pass in [`load_nfl_pbp`](../reference/index.qmd) to rank offenses.
...
[`load_nfl_snap_counts`](../reference/index.qmd) carries `offense_pct` per game — average it to find the backs their teams simply would not take off the field.
...
[`load_nfl_schedule`](../reference/index.qmd) carries the final `result` (home margin). Take its absolute value and sort ascending to surface the one-score thrillers — built-in betting lines ride along too.
...
- **Premium native API** — the full `nfl_*` endpoint set:
  [`docs/docs/nfl/reference/nfl_api.md`](../reference/index.qmd)
- **NextGen Stats & loaders** — `nfl_ngs_*` and `load_nfl_*`:
  [`docs/docs/nfl/reference/additional.md`](../reference/index.qmd)
  and [`docs/docs/nfl/reference/loaders.md`](../reference/index.qmd)
- **ESPN secondary path** — every `espn_nfl_*` wrapper:
  [`docs/docs/nfl/reference/site.md`](../reference/index.qmd)

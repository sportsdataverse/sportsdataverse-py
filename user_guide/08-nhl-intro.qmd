---
title: "NHL tutorial"
description: "NHL walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`nhl_web_schedule`](../reference/index.qmd) | A day's games + scores, native `id`s | ⭐ NHL api-web |
| [`nhl_web_pbp`](../reference/index.qmd) | Event-level play-by-play (one row per event) | ⭐ NHL api-web |
| [`nhl_boxscore`](../reference/index.qmd) | One row per player (skaters + goalies) | ⭐ NHL api-web |
| [`nhl_standings`](../reference/index.qmd) | Team standings with conference/division | ⭐ NHL api-web |
| [`nhl_roster`](../reference/index.qmd) | A club's roster for a season | ⭐ NHL api-web |
| [`nhl_club_schedule_season`](../reference/index.qmd) | A team's full-season schedule | ⭐ NHL api-web |
| [`nhl_player_game_log`](../reference/index.qmd) | A player's game-by-game line | ⭐ NHL api-web |
| [`nhl_player_landing`](../reference/index.qmd) | A player's bio + career snapshot | ⭐ NHL api-web |
| [`nhl_skater_leaders`](../reference/index.qmd) | Season skater leaderboard | ⭐ NHL api-web |
| [`nhl_goalie_leaders`](../reference/index.qmd) | Season goalie leaderboard | ⭐ NHL api-web |
| [`nhl_club_stats`](../reference/index.qmd) | A club's full skater + goalie stat lines | ⭐ NHL api-web |
| [`nhl_player_landing`](../reference/index.qmd) | A player's bio + career snapshot | ⭐ NHL api-web |
| [`nhl_score`](../reference/index.qmd) | A day's final scores + series context | ⭐ NHL api-web |
| [`nhl_draft_picks`](../reference/index.qmd) | Draft board for a year/round | ⭐ NHL api-web |
| [`nhl_edge_skater_skating_speed_detail`](../reference/index.qmd) | A skater's tracked speed vs league avg + percentile | ⭐ NHL EDGE |
| [`nhl_edge_skater_landing`](../reference/index.qmd) | EDGE skater leaderboards (hardest shot, top speed…) | ⭐ NHL EDGE |
| [`nhl_edge_team_landing`](../reference/index.qmd) | EDGE team-level tracking leaders | ⭐ NHL EDGE |
| [`nhl_edge_goalie_landing`](../reference/index.qmd) | EDGE goalie tracking leaders | ⭐ NHL EDGE |
| [`nhl_stats_rest_leaders_skaters`](../reference/index.qmd) | Stats-REST top-10 skaters by attribute | ⭐ NHL stats-REST |
| [`nhl_stats_rest_leaders_goalies`](../reference/index.qmd) | Stats-REST top-10 goalies by attribute | ⭐ NHL stats-REST |
| [`nhl_records_franchises`](../reference/index.qmd) | Every franchise in NHL history (Records API) | ⭐ NHL records |
| [`nhl_records_franchise_team_totals`](../reference/index.qmd) | All-time W/L/points per franchise | ⭐ NHL records |
| [`load_nhl_schedule`](../reference/index.qmd) | Pre-built schedule parquet (offline-friendly) | 📦 loader |
| [`load_nhl_team_box`](../reference/index.qmd) | Pre-built team box parquet | 📦 loader |
| [`load_nhl_player_box`](../reference/index.qmd) | Pre-built player box parquet | 📦 loader |
| [`espn_nhl_teams`](../reference/index.qmd) | ESPN team directory | ESPN |
| [`espn_nhl_schedule`](../reference/index.qmd) | ESPN schedule for a date | ESPN |
| [`espn_nhl_pbp`](../reference/index.qmd) | ESPN play-by-play (a dict) | ESPN |
| [`espn_nhl_standings`](../reference/index.qmd) | ESPN standings | ESPN |
...
[`nhl_web_schedule(date='YYYY-MM-DD')`](../reference/index.qmd)
...
[`nhl_web_pbp(game_id=...)`](../reference/index.qmd) returns
...
[`nhl_boxscore(game_id=...)`](../reference/index.qmd) gives
...
[`nhl_standings(date='YYYY-MM-DD')`](../reference/index.qmd)
...
|---|---|
| [`nhl_edge_skater_skating_speed_detail`](../reference/index.qmd) | top speed, speed bursts, vs league avg |
| [`nhl_edge_skater_landing`](../reference/index.qmd) | skater leaders (hardest shot, top speed…) |
| [`nhl_edge_team_landing`](../reference/index.qmd) | team-level tracking leaders |
...
- **Stats-REST** (`api.nhle.com/stats/rest`) — clean leaderboard frames.
  [`nhl_stats_rest_leaders_skaters(attribute=...)`](../reference/index.qmd)
  returns a tidy top-10 for any attribute (`goals`, `points`, `assists`, …);
  [`nhl_stats_rest_leaders_goalies`](../reference/index.qmd)
  is the goalie twin.
- **Records** (`records.nhl.com`) — historical reference data, e.g.
  [`nhl_records_franchises`](../reference/index.qmd).
...
Grab a `game_id` from [`nhl_web_schedule`](../reference/index.qmd),
then pull the [`nhl_boxscore`](../reference/index.qmd) and
[`nhl_web_pbp`](../reference/index.qmd) together — the box
...
[`nhl_club_schedule_season`](../reference/index.qmd)
for the full slate and [`nhl_roster`](../reference/index.qmd)
for the player list.
...
Pair a single player's [`nhl_player_game_log`](../reference/index.qmd)
(game-by-game) with the season-wide
[`nhl_skater_leaders`](../reference/index.qmd) board
...
[`nhl_edge_skater_landing`](../reference/index.qmd)
...
The native [`nhl_standings`](../reference/index.qmd)
...
[`nhl_club_stats`](../reference/index.qmd) returns a
...
[`nhl_draft_picks`](../reference/index.qmd) returns one
...
[`load_nhl_team_box`](../reference/index.qmd) parquet
...
[`nhl_records_franchise_team_totals`](../reference/index.qmd)
...
before arithmetic), and [`espn_nhl_pbp`](../reference/index.qmd)
returns a **dict** whose `plays` use raw ESPN dot-notation. ESPN game ids look
like `401675111`.

| Function | What it gives you |
|---|---|
| [`espn_nhl_teams`](../reference/index.qmd) | ESPN team directory |
| [`espn_nhl_schedule`](../reference/index.qmd) | schedule for a date |
| [`espn_nhl_pbp`](../reference/index.qmd) | play-by-play (a dict) |
| [`espn_nhl_standings`](../reference/index.qmd) | standings |
...
| Function | Release |
|---|---|
| [`load_nhl_schedule`](../reference/index.qmd) | schedules |
| [`load_nhl_team_box`](../reference/index.qmd) | team box |
| [`load_nhl_player_box`](../reference/index.qmd) | player box |
| [`load_nhl_pbp`](../reference/index.qmd) | play-by-play |
...
- Full reference, by source:
  [NHL Web API](../reference/index.qmd) ·
  [NHL EDGE](../reference/index.qmd) ·
  [Stats-REST](../reference/index.qmd) ·
  [Records](../reference/index.qmd) ·
  [loaders](../reference/index.qmd) ·
  [additional / ESPN](../reference/index.qmd)

---
title: "CFB tutorial"
description: "CFB walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`load_cfb_pbp`](../reference/index.qmd) | Full **play-by-play** with EPA/WPA, since 2003 | ⭐ release |
| [`load_cfb_rosters`](../reference/index.qmd) | Season **rosters** (bio, position, hometown) | ⭐ release |
| [`load_cfb_schedule`](../reference/index.qmd) | Season **schedule** + results + Elo | ⭐ release |
| [`load_cfb_team_info`](../reference/index.qmd) | **Team** metadata: conference, colors, venue | ⭐ release |
| [`load_cfb_betting_lines`](../reference/index.qmd) | Historical **betting market** lines (spread/total/ML) | ⭐ release |
| [`espn_cfb_scoreboard`](../reference/index.qmd) | Live + recent **scoreboard** for a date/week | ⭐ ESPN |
| [`espn_cfb_schedule`](../reference/index.qmd) | ESPN **schedule** frame for a date/week | ⭐ ESPN |
| [`espn_cfb_teams`](../reference/index.qmd) | Every FBS/FCS **team** (grab `team_id`s) | ⭐ ESPN |
| [`espn_cfb_team_roster`](../reference/index.qmd) | One team's **roster** | ⭐ ESPN |
| [`espn_cfb_team_schedule`](../reference/index.qmd) | One team's **schedule** | ⭐ ESPN |
| [`espn_cfb_standings`](../reference/index.qmd) | Conference / division **standings** | ⭐ ESPN |
| [`espn_cfb_rankings`](../reference/index.qmd) | AP / Coaches / CFP **polls** | ⭐ ESPN |
| [`espn_cfb_leaders`](../reference/index.qmd) | League **stat leaders** by category | ⭐ ESPN |
| [`espn_cfb_recruits`](../reference/index.qmd) | Season **recruiting** class | ⭐ ESPN |
| [`espn_cfb_play_participants`](../reference/index.qmd) | Per-play **athletes** (passer/rusher/tackler…) | ⭐ ESPN |
| [`CFBPlayProcess`](../reference/index.qmd) | Full ESPN **PBP pipeline** (EPA/WPA + box) | ⭐ ESPN |
| [`most_recent_cfb_season`](../reference/index.qmd) | The current season year helper | helper |
...
|---|---|---|
| [`load_cfb_schedule`](../reference/index.qmd) | one row / game | scores, Elo, neutral-site & conference flags |
...
[`load_cfb_rosters`](../reference/index.qmd) gives you
...
[`load_cfb_team_info`](../reference/index.qmd)
...
The crown jewel. [`load_cfb_pbp`](../reference/index.qmd)
...
[`espn_cfb_scoreboard`](../reference/index.qmd) takes a
...
[`espn_cfb_teams`](../reference/index.qmd) lists every
...
[`espn_cfb_play_participants`](../reference/index.qmd)
...
[`load_cfb_betting_lines`](../reference/index.qmd) is a premium release frame of historical sportsbook lines. Average the spread across books per game and sort to surface the most lopsided favorites — the mismatches Vegas saw coming a mile away.
...
| Function | Use it for |
|---|---|
| [`espn_cfb_standings`](../reference/index.qmd) | conference / division standings |
| [`espn_cfb_rankings`](../reference/index.qmd) | AP / Coaches / CFP polls |
| [`espn_cfb_leaders`](../reference/index.qmd) | league stat leaders by category |
| [`espn_cfb_recruits`](../reference/index.qmd) | a season's recruiting class |
...
[`CFBPlayProcess`](../reference/index.qmd) drives the
...
- 🗄️ **Loaders** are your premium fast-path — full reference on the
  [Loaders](../reference/index.qmd) page (`load_cfb_pbp`,
  `load_cfb_rosters`, `load_cfb_schedule`, `load_cfb_team_info`).
- 📡 **ESPN families** live across the
  [Site](../reference/index.qmd), [Web](../reference/index.qmd),
  [Core](../reference/index.qmd) and
  [Additional](../reference/index.qmd) reference pages.

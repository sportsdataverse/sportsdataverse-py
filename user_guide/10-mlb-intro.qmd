---
title: "MLB tutorial"
description: "MLB walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`mlb_schedule`](../reference/index.qmd) · [`parse_mlb_api_schedule`](../reference/index.qmd) | Games for a date / range — one row per game (with `game_pk`) | 🟢 **MLB Stats API** |
| [`mlb_teams`](../reference/index.qmd) · [`parse_mlb_api_teams`](../reference/index.qmd) | Every club — one row per team | 🟢 **MLB Stats API** |
| [`mlb_standings`](../reference/index.qmd) · [`parse_mlb_api_standings`](../reference/index.qmd) | Division standings — wins, losses, run diff | 🟢 **MLB Stats API** |
| [`mlb_team_roster`](../reference/index.qmd) | A team's roster — one row per player | 🟢 **MLB Stats API** |
| [`mlb_person`](../reference/index.qmd) | A player's bio (one tidy row) | 🟢 **MLB Stats API** |
| [`mlb_person_stats`](../reference/index.qmd) · [`parse_mlb_api_person_stats`](../reference/index.qmd) | A player's season stat splits | 🟢 **MLB Stats API** |
| [`mlb_boxscore`](../reference/index.qmd) | Full game box score | 🟢 **MLB Stats API** |
| [`mlb_play_by_play`](../reference/index.qmd) | Plate-appearance-level play-by-play | 🟢 **MLB Stats API** |
| [`mlb_stats_leaders`](../reference/index.qmd) | League leaders for any stat (HR, AVG, ERA, …) | 🟢 **MLB Stats API** |
| [`mlb_win_probability`](../reference/index.qmd) | Per-play win probability + WPA for a game | 🟢 **MLB Stats API** |
| [`mlb_awards`](../reference/index.qmd) · [`mlb_award_recipients`](../reference/index.qmd) | Award catalog + season winners (MVP, Cy Young, …) | 🟢 **MLB Stats API** |
| [`mlb_draft`](../reference/index.qmd) | Amateur draft board — one row per pick | 🟢 **MLB Stats API** |
| [`mlb_statcast_search`](../reference/index.qmd) | Every pitch matching a filter — ~110 cols/pitch; auto date-chunks past the 25k cap; friendly filters (`batters_lookup`, `pitch_type`, `at_bat_result`, …) | 🔵 **Statcast** |
| [`mlb_statcast_search_minors`](../reference/index.qmd) · [`mlb_statcast_search_wbc`](../reference/index.qmd) | Same pitch search for MiLB and the World Baseball Classic | 🔵 **Statcast** |
| `mlb_statcast_leaderboard_*` (37 of them) — e.g. [`…_sprint_speed`](../reference/index.qmd), [`…_expected_stats`](../reference/index.qmd), [`…_bat_tracking`](../reference/index.qmd), [`…_outs_above_average`](../reference/index.qmd) | Every Savant leaderboard: expected stats, sprint speed, bat tracking, pitch arsenals/movement/tempo, OAA, arm strength, catcher framing/blocking/throwing, baserunning, park factors, … | 🔵 **Statcast** |
| [`mlb_statcast_gamefeed`](../reference/index.qmd) | Savant single-game feed — one tidy row per pitch | 🔵 **Statcast** |
| [`mlb_statcast_player`](../reference/index.qmd) | A player's Savant page metrics | 🔵 **Statcast** |
| [`espn_mlb_teams`](../reference/index.qmd) · [`espn_mlb_schedule`](../reference/index.qmd) | ESPN teams / schedule (wide frames) | ⚪ ESPN |
| [`most_recent_mlb_season`](../reference/index.qmd) | Current season helper | ⚪ helper |
...
[`mlb_schedule`](../reference/index.qmd) returns the
raw JSON `dict`; its partner
[`parse_mlb_api_schedule`](../reference/index.qmd)
...
[`mlb_standings`](../reference/index.qmd) covers
both leagues by default (`league_id="103,104"`).
[`parse_mlb_api_standings`](../reference/index.qmd)
...
[`mlb_teams`](../reference/index.qmd) +
[`parse_mlb_api_teams`](../reference/index.qmd) lists every
club — grab a `team_id` here.
[`mlb_team_roster`](../reference/index.qmd) then
...
[`mlb_person`](../reference/index.qmd) returns a one-row
bio frame. [`mlb_person_stats`](../reference/index.qmd)
returns the raw stat-split `dict`;
[`parse_mlb_api_person_stats`](../reference/index.qmd)
...
[`mlb_statcast_search`](../reference/index.qmd) pulls each
...
[`mlb_boxscore`](../reference/index.qmd). Asking for
...
[`mlb_play_by_play`](../reference/index.qmd)
...
[`mlb_stats_leaders`](../reference/index.qmd)
...
[`mlb_statcast_leaderboard_expected_stats`](../reference/index.qmd)
...
[`mlb_statcast_leaderboard_bat_tracking`](../reference/index.qmd)
...
[`mlb_statcast_leaderboard_outs_above_average`](../reference/index.qmd)
...
[`mlb_statcast_gamefeed`](../reference/index.qmd)
...
[`mlb_win_probability`](../reference/index.qmd)
...
[`mlb_awards`](../reference/index.qmd) is the catalog of
every award id; [`mlb_award_recipients`](../reference/index.qmd)
...
[`mlb_draft`](../reference/index.qmd) returns the amateur
...
path: [`espn_mlb_schedule`](../reference/index.qmd)
...
[`espn_mlb_teams`](../reference/index.qmd) returns one
...
- Full reference: the **MLB** pages in the sidebar —
  [MLB Stats API + Statcast helpers](../reference/index.qmd),
  [the full MLB Stats API surface](../reference/index.qmd),
  and the ESPN [core](../reference/index.qmd) / [site](../reference/index.qmd) / [web](../reference/index.qmd) endpoints.

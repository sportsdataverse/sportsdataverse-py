...
description: "Junior & minor hockey walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|
| [`ahl_schedule`](../reference/index.qmd) | Games + results, one row per game |
| [`ahl_standings`](../reference/index.qmd) | Team standings |
| [`ahl_teams`](../reference/index.qmd) | Teams in a season (grab `team_id`s) |
| [`ahl_team_roster`](../reference/index.qmd) | A team's roster |
| [`ahl_pbp`](../reference/index.qmd) | Event-level play-by-play |
| [`ahl_player_stats`](../reference/index.qmd) | A player's full season-by-season stat line |
| [`ahl_leaders`](../reference/index.qmd) | Statistical leaders |
| [`ahl_game_summary`](../reference/index.qmd) | Box-score summary for a game (goals / penalties / stars) |
| [`ahl_game_corsi`](../reference/index.qmd) | Corsi / Fenwick shot-attempt metrics |
| [`ahl_game_shifts`](../reference/index.qmd) | Shift charts |
| [`ahl_player_toi`](../reference/index.qmd) | Time-on-ice |
| [`ahl_season_id`](../reference/index.qmd) · `most_recent_ahl_season` | Season helpers |
...
[`ahl_schedule`](../reference/index.qmd) (and its siblings) returns one row per game.
...
[`ohl_standings`](../reference/index.qmd) (shown for the OHL) gives one row per team.
...
List teams with [`whl_teams`](../reference/index.qmd), grab a `team_id`, then pull the
roster with [`whl_team_roster`](../reference/index.qmd).
...
Take a `game_id` from the schedule, then [`ahl_pbp`](../reference/index.qmd) for events and
[`ahl_game_corsi`](../reference/index.qmd) for Corsi/Fenwick — derived from the same feed.
...
[`qmjhl_leaders`](../reference/index.qmd) hands back a ready-made leaderboard —
...
[`whl_player_stats`](../reference/index.qmd) returns every season they've played —
...
[`ohl_game_summary`](../reference/index.qmd) returns a **dict of frames** —
...
from [`whl_team_roster`](../reference/index.qmd).
...
straight into a pandas workflow. And [`ahl_season_id`](../reference/index.qmd)
...
| Function | Metric |
|---|---|
| [`ahl_game_corsi`](../reference/index.qmd) | Corsi / Fenwick shot-attempt share |
| [`ahl_game_shifts`](../reference/index.qmd) | shift charts (who's on the ice) |
| [`ahl_player_toi`](../reference/index.qmd) | time-on-ice per player |
| [`ahl_leaders`](../reference/index.qmd) | statistical leaders |

---
title: "MBB tutorial"
description: "MBB walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`espn_mbb_teams`](../reference/index.qmd) | Every D-I team (grab `team_id`s) | 🟥 ESPN ⭐ |
| [`espn_mbb_schedule`](../reference/index.qmd) | Games + results for a date / window | 🟥 ESPN ⭐ |
| [`espn_mbb_scoreboard`](../reference/index.qmd) | Rich scoreboard for a date (status, lines, odds) | 🟥 ESPN ⭐ |
| [`espn_mbb_standings`](../reference/index.qmd) | Conference standings, one row per team | 🟥 ESPN ⭐ |
| [`espn_mbb_rankings`](../reference/index.qmd) | AP / Coaches poll (in-season) | 🟥 ESPN ⭐ |
| [`espn_mbb_summary`](../reference/index.qmd) | Full game summary: box, plays, win prob | 🟥 ESPN ⭐ |
| [`espn_mbb_team_roster`](../reference/index.qmd) | A team's roster | 🟥 ESPN ⭐ |
| [`espn_mbb_pbp`](../reference/index.qmd) | Event-level play-by-play for a game | 🟥 ESPN ⭐ |
| [`espn_mbb_game_rosters`](../reference/index.qmd) | Who dressed + started for one game | 🟥 ESPN ⭐ |
| [`espn_mbb_player_stats`](../reference/index.qmd) | A player's season stat line | 🟥 ESPN ⭐ |
| [`fox_mbb_league_leaders`](../reference/index.qmd) | Stat leaders (scoring, rebounds, …) | 🦊 Fox ⭐ |
| [`fox_mbb_standings`](../reference/index.qmd) | Fox conference standings for a team | 🦊 Fox ⭐ |
| [`fox_mbb_team_roster`](../reference/index.qmd) | Fox roster for a team | 🦊 Fox |
| [`espn_mbb_team_schedule`](../reference/index.qmd) | One team's full season schedule | 🟥 ESPN ⭐ |
| [`espn_mbb_conferences`](../reference/index.qmd) | Conference / group catalog | 🟥 ESPN ⭐ |
| [`load_mbb_schedule`](../reference/index.qmd) | Whole-season schedule parquet | 📦 loader |
| [`load_mbb_player_boxscore`](../reference/index.qmd) | Season player box scores | 📦 loader |
| [`load_mbb_team_boxscore`](../reference/index.qmd) | Season team box scores | 📦 loader |
| [`load_mbb_pbp`](../reference/index.qmd) | Season play-by-play parquet | 📦 loader |
| [`most_recent_mbb_season`](../reference/index.qmd) | Current season-year helper | 🛠️ helper |
...
Start with [`espn_mbb_teams`](../reference/index.qmd) —
...
[`espn_mbb_schedule`](../reference/index.qmd) takes a
...
[`espn_mbb_scoreboard`](../reference/index.qmd) is the
...
[`espn_mbb_standings`](../reference/index.qmd) returns one
...
[`fox_mbb_league_leaders`](../reference/index.qmd)
...
[`espn_mbb_team_roster`](../reference/index.qmd) returns
...
[`load_mbb_player_boxscore`](../reference/index.qmd)
...
[`espn_mbb_pbp`](../reference/index.qmd) returns a dict;
...
[`load_mbb_team_boxscore`](../reference/index.qmd) gives one row per team-game with the opponent's score attached, so a single group-by ranks every program by points scored minus points allowed — the cleanest one-number power proxy. Pure parquet, no live endpoint.
...
Points-per-game rewards volume; **true shooting %** rewards *efficiency* — it folds threes and free throws into one rate via `TS% = PTS / (2 · (FGA + 0.44·FTA))`. We compute it straight from [`load_mbb_player_boxscore`](../reference/index.qmd), keeping only high-usage scorers.
...
[`espn_mbb_conferences`](../reference/index.qmd) is the group catalog; [`espn_mbb_standings`](../reference/index.qmd) carries a `group_name` per team. Filter standings to a single league — here the Big 12 — to get a clean intra-conference pecking order.
...
[`espn_mbb_team_schedule`](../reference/index.qmd) returns every game on one team's slate for a season — matchup name, week and season type — perfect for building an opponent list. We use UConn's 2024 championship run.
...
[`fox_mbb_league_leaders`](../reference/index.qmd) isn't just a player board — flip `who="team"` and pick `category="rebounds"` to rank programs on the glass straight from FoxSports. No IDs needed.
...
[`load_mbb_pbp`](../reference/index.qmd) is the whole season's play-by-play in one parquet — no live game needed. We slice it to scoring plays in the final minute of the second half: every late-game dagger across the year.
...
[`espn_mbb_summary`](../reference/index.qmd) is the Swiss
...
[`espn_mbb_game_rosters`](../reference/index.qmd)
...
- 🟥 **ESPN** wrappers (`espn_mbb_*`) cover the live site + core APIs —
  ...
  [additional](../reference/index.qmd) and
  [site](../reference/index.qmd) reference pages.
- 🦊 **FoxSports** wrappers (`fox_mbb_*`) — leaders, standings, rosters,
  boxscores and odds in [additional](../reference/index.qmd).
- 📦 **Loaders** (`load_mbb_*`) read whole seasons of parquet — see
  [loaders](../reference/index.qmd). Pass `return_as_pandas=True` anywhere

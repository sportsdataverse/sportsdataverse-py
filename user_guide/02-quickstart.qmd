...
description: "Quickstart walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|:---:|---|---|---|
| 🏀 **NBA** | [tutorial](05-nba-intro.qmd) · [ref](../reference/index.qmd) | ✅ | — | — | `load_nba_pbp`, `load_nba_team_boxscore` |
| 🏀 **WNBA** | [tutorial](09-wnba-intro.qmd) · [ref](../reference/index.qmd) | ✅ | — | — | `load_wnba_pbp`, `load_wnba_player_boxscore` |
| 🏀 **MBB** (NCAA M) | [tutorial](07-mbb-intro.qmd) · [ref](../reference/index.qmd) | ✅ | — | — | `load_mbb_pbp`, `load_mbb_team_boxscore` |
| 🏀 **WBB** (NCAA W) | [tutorial](06-wbb-intro.qmd) · [ref](../reference/index.qmd) | ✅ | — | — | `load_wbb_pbp`, `load_wbb_team_boxscore` |
| 🏈 **NFL** | [tutorial](04-nfl-intro.qmd) · [ref](../reference/index.qmd) | ✅ | 💳 `nfl_*` (`api.nfl.com`) | 💳 Next Gen Stats `nfl_ngs_*` | `load_nfl_pbp`, `load_nfl_player_stats`, `load_injuries` |
| 🏈 **CFB** (College) | [tutorial](03-cfb-intro.qmd) · [ref](../reference/index.qmd) | ✅ | `yahoo_cfb_*`, `fox_cfb_*` | — | `load_cfb_pbp` |
| ⚾ **MLB** | [tutorial](10-mlb-intro.qmd) · [ref](../reference/index.qmd) | ✅ | 💳 `mlb_*` (MLB Stats API) | 💳 Statcast `mlb_statcast_*` | `load_mlb_pbp`, `load_mlb_team_boxscore` |
| 🏒 **NHL** | [tutorial](08-nhl-intro.qmd) · [ref](../reference/index.qmd) | ✅ | 💳 `nhl_*` (`api-web`) | 💳 NHL EDGE `nhl_edge_*` | `load_nhl_pbp`, `load_nhl_team_boxscore` |
| 🏒 **PWHL** (Women's pro) | [tutorial](11-pwhl-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `pwhl_*` (HockeyTech) | corsi / shifts / TOI | `load_pwhl_schedules` |
| 🏒 **AHL** (Minor pro) | [tutorial](12-junior-hockey-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `ahl_*` (HockeyTech) | corsi / shifts / TOI | — |
| 🏒 **OHL** (CHL junior) | [tutorial](12-junior-hockey-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `ohl_*` (HockeyTech) | corsi / shifts / TOI | — |
| 🏒 **WHL** (CHL junior) | [tutorial](12-junior-hockey-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `whl_*` (HockeyTech) | corsi / shifts / TOI | — |
| 🏒 **QMJHL** (CHL junior) | [tutorial](12-junior-hockey-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `qmjhl_*` (HockeyTech) | corsi / shifts / TOI | — |
| 🎲 **Betting odds** | [tutorial](13-odds-intro.qmd) · [ref](../reference/index.qmd) | — | 💳 `toa_*` (The Odds API) | line history / props | — |
...
- [`02_cfb_intro`](03-cfb-intro.qmd) — 🏈 college football
- [`03_nfl_intro`](04-nfl-intro.qmd) — 🏈 NFL (`api.nfl.com` + nflverse)
- [`04_nba_intro`](05-nba-intro.qmd) — 🏀 NBA
- [`05_wbb_intro`](06-wbb-intro.qmd) — 🏀 NCAA women's basketball
- [`06_mbb_intro`](07-mbb-intro.qmd) — 🏀 NCAA men's basketball
- [`07_nhl_intro`](08-nhl-intro.qmd) — 🏒 NHL (`api-web` + EDGE + ESPN)
- [`08_wnba_intro`](09-wnba-intro.qmd) — 🏀 WNBA
- [`09_mlb_intro`](10-mlb-intro.qmd) — ⚾ MLB (Stats API + Statcast + ESPN)
- [`10_pwhl_intro`](11-pwhl-intro.qmd) — 🏒 PWHL
- [`11_junior_hockey_intro`](12-junior-hockey-intro.qmd) — 🏒 AHL / OHL / WHL / QMJHL
- [`12_odds_intro`](13-odds-intro.qmd) — 🎲 Betting odds (The Odds API)

**Reference indexes:**
[NBA](../reference/index.qmd) · [WNBA](../reference/index.qmd) · [MBB](../reference/index.qmd) ·
[WBB](../reference/index.qmd) · [NFL](../reference/index.qmd) · [CFB](../reference/index.qmd) ·
[MLB](../reference/index.qmd) · [NHL](../reference/index.qmd) · [PWHL](../reference/index.qmd) ·
[AHL](../reference/index.qmd) · [OHL](../reference/index.qmd) · [WHL](../reference/index.qmd) ·
[QMJHL](../reference/index.qmd) · [Odds](../reference/index.qmd).

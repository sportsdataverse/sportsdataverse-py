---
title: "NBA tutorial"
description: "NBA walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|---|
| [`espn_nba_teams`](../reference/index.qmd) | All 30 NBA teams (grab `team_id`s here) | ⭐ ESPN |
| [`espn_nba_scoreboard`](../reference/index.qmd) | A day's slate — scores, status, matchups | ⭐ ESPN |
| [`espn_nba_schedule`](../reference/index.qmd) | Schedule for a date / date-range | ⭐ ESPN |
| [`espn_nba_standings`](../reference/index.qmd) | Conference standings (W-L, win%, streak) | ⭐ ESPN |
| [`espn_nba_team_roster`](../reference/index.qmd) | A team's active roster | ⭐ ESPN |
| [`espn_nba_team_schedule`](../reference/index.qmd) | One team's full-season schedule | ⭐ ESPN |
| [`espn_nba_player_gamelog`](../reference/index.qmd) | A player's game-by-game log | ⭐ ESPN |
| [`espn_nba_leaders`](../reference/index.qmd) | League statistical leaders | ⭐ ESPN |
| [`espn_nba_pbp`](../reference/index.qmd) | Full game payload (play-by-play, win prob, box) | ⭐ ESPN |
| [`espn_nba_game_rosters`](../reference/index.qmd) | Both teams' rosters for one game | ⭐ ESPN |
| [`load_nba_schedule`](../reference/index.qmd) | Multi-season schedule parquet | 📦 release |
| [`load_nba_player_boxscore`](../reference/index.qmd) | Player box scores, every game | 📦 release |
| [`load_nba_standings`](../reference/index.qmd) | Historical standings | 📦 release |
| [`espn_nba_injuries`](../reference/index.qmd) | League-wide injury report, one row per team | ⭐ ESPN |
| [`load_nba_team_boxscore`](../reference/index.qmd) | Team box scores, every game (off/def, shooting) | 📦 release |
| [`load_nba_shots`](../reference/index.qmd) | Every made shot with court coordinates | 📦 release |
| [`most_recent_nba_season`](../reference/index.qmd) | The current season year helper | 🧮 util |
...
Start with [`espn_nba_teams`](../reference/index.qmd) —
...
[`espn_nba_scoreboard`](../reference/index.qmd) returns a
...
[`espn_nba_standings`](../reference/index.qmd) gives one
...
Grab a `team_id` from [`espn_nba_teams`](../reference/index.qmd),
then pull the active roster with
[`espn_nba_team_roster`](../reference/index.qmd).
...
[`espn_nba_team_schedule`](../reference/index.qmd)
...
[`espn_nba_player_gamelog`](../reference/index.qmd)
...
[`load_nba_player_boxscore`](../reference/index.qmd)
...
The [`load_nba_team_boxscore`](../reference/index.qmd)
...
The [`load_nba_standings`](../reference/index.qmd)
...
[`load_nba_shots`](../reference/index.qmd) is one row per
...
[`espn_nba_injuries`](../reference/index.qmd) hits ESPN
...
Now for the granular stuff. [`espn_nba_pbp`](../reference/index.qmd)
...
[`espn_nba_game_rosters`](../reference/index.qmd) for who actually
suited up.
...
[`espn_nba_game_rosters`](../reference/index.qmd) returns both teams'
...
| Loader | Grain |
|---|---|
| [`load_nba_schedule`](../reference/index.qmd) | one row per game |
| [`load_nba_player_boxscore`](../reference/index.qmd) | one row per player-game |
| [`load_nba_standings`](../reference/index.qmd) | one row per team-season |
...
- Full reference lives in the **NBA** section of the sidebar:
  [ESPN site API](../reference/index.qmd) ·
  [ESPN web API](../reference/index.qmd) ·
  [ESPN core API](../reference/index.qmd) ·
  [additional functions](../reference/index.qmd) ·

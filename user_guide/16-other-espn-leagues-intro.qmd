...
description: "Other ESPN leagues walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
[`espn_ufl_scoreboard(dates=YYYYMMDD)`](../reference/index.qmd)
...
[`espn_ufl_teams_site()`](../reference/index.qmd)
...
[`espn_ufl_standings()`](../reference/index.qmd)
...
[`espn_ufl_team_schedule(team_id=, season=)`](../reference/index.qmd)
...
[`espn_ufl_summary(event_id=)`](../reference/index.qmd)
...
[`espn_college_baseball_scoreboard(dates=YYYYMMDD)`](../reference/index.qmd)
...
[`espn_college_baseball_standings()`](../reference/index.qmd)
returns conference standings. [`espn_college_baseball_rankings()`](../reference/index.qmd)
...
[`espn_mch_scoreboard(dates=YYYYMMDD)`](../reference/index.qmd)
returns the game slate. [`espn_mch_teams_site()`](../reference/index.qmd)
...
[`espn_mch_team_schedule(team_id=, season=)`](../reference/index.qmd)
and their roster with
[`espn_mch_team_roster(team_id=, season=)`](../reference/index.qmd).
...
[`espn_{prefix}_news()`](../reference/index.qmd) and
[`espn_{prefix}_injuries()`](../reference/index.qmd)
...
- **Spring / pro football reference docs:**
  [UFL](../reference/index.qmd) ·
  [XFL](../reference/index.qmd) ·
  [CFL](../reference/index.qmd)
- **College baseball / softball reference docs:**
  [College Baseball](../reference/index.qmd) ·
  [College Softball](../reference/index.qmd)
- **NCAA hockey reference docs:**
  [Men's College Hockey](../reference/index.qmd) ·
  [Women's College Hockey](../reference/index.qmd)

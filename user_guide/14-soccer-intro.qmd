...
description: "Soccer walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
|---|---|
| [`espn_soccer_scoreboard`](../reference/index.qmd) | ⭐ Match results / live scores for a date |
| [`espn_soccer_standings`](../reference/index.qmd) | ⭐ League / conference / group standings |
| [`espn_soccer_summary`](../reference/index.qmd) | ⭐ Full match summary — lineups, key events, team stats, commentary |
| [`espn_soccer_teams_site`](../reference/index.qmd) | ⭐ Every team in the league (grab `team_id`s) |
| [`espn_soccer_team_roster`](../reference/index.qmd) | One team's current squad |
| [`espn_soccer_team_schedule`](../reference/index.qmd) | A team's fixtures & results |
| [`espn_soccer_news`](../reference/index.qmd) | Latest news headlines for a league |
| [`espn_soccer_injuries`](../reference/index.qmd) | Current injury list |
| [`espn_soccer_leaders`](../reference/index.qmd) | Stat leaders by category |
| [`espn_soccer_player_info`](../reference/index.qmd) | Player bio & metadata |
| [`espn_soccer_player_stats`](../reference/index.qmd) | Player season statistics |
| [`espn_soccer_game_probabilities`](../reference/index.qmd) | In-game win probabilities |
...
[`espn_soccer_scoreboard`](../reference/index.qmd)
...
[`espn_soccer_standings`](../reference/index.qmd)
...
[`espn_soccer_summary`](../reference/index.qmd) fetches
...
[`espn_soccer_teams_site`](../reference/index.qmd)
...
[`espn_soccer_team_roster`](../reference/index.qmd)
...
[`espn_soccer_team_schedule`](../reference/index.qmd)
...
- [`espn_soccer_news`](../reference/index.qmd) — latest
  editorial headlines for a league, optionally limited by `limit=`.
- [`espn_soccer_injuries`](../reference/index.qmd) —
...
[`espn_soccer_leaders`](../reference/index.qmd) returns

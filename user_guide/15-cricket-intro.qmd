...
description: "Cricket walkthrough — the canonical sportsdataverse surface, ported from the Docusaurus tutorials. Code cells show the calls; run them in your own session."
jupyter: python3
---
...
[`espn_cricket_scoreboard`](../reference/index.qmd)
...
[`espn_cricket_standings`](../reference/index.qmd)
...
[`espn_cricket_summary`](../reference/index.qmd) is the
...
[`espn_cricket_news`](../reference/index.qmd) and
[`espn_cricket_injuries`](../reference/index.qmd)
...
[`espn_cricket_calendar`](../reference/index.qmd)

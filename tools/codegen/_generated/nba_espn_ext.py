...
def espn_nba_season_week_powerindex(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    ...
    **kwargs,
    ...
    Example URL: https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/2024/types/2/weeks/8/powerindex
    ...
    _params.update(_caller_params)
    raw = _get(
        f"https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/{season}/types/{season_type}/weeks/{week}/powerindex",
        params=_params,
        **kwargs,
    )
    if return_parsed:
...
def espn_nba_fpi(
    ...
    **kwargs,
    ...
    _params.update(_caller_params)
    raw = _get(
        "https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/nba/powerindex",
        params=_params,
        **kwargs,
    )
    if return_parsed:

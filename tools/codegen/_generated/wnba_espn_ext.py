...
"""ESPN endpoint wrappers for WNBA (basketball/wnba). Generated."""
...
def espn_wnba_season_week_powerindex(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    ...
    **kwargs,
    ...
    Example URL: https://sports.core.api.espn.com/v2/sports/basketball/leagues/wnba/seasons/2024/types/2/weeks/8/powerindex
    ...
    _params.update(_caller_params)
    raw = _get(
        f"https://sports.core.api.espn.com/v2/sports/basketball/leagues/wnba/seasons/{season}/types/{season_type}/weeks/{week}/powerindex",
        params=_params,
        **kwargs,
    )
    if return_parsed:
...
def espn_wnba_season_week_games(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    limit: Optional[int] = 500,
...
def espn_wnba_player_vs_player(
    athlete_id: Union[int, str],
...
def espn_wnba_game_competition(
    event_id: Union[int, str],
...
def espn_wnba_fpi(
    ...
    **kwargs,
    ...
    _params.update(_caller_params)
    raw = _get(
        "https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/wnba/powerindex",
        params=_params,
        **kwargs,
    )
    if return_parsed:

...
def espn_wc_season_week_powerindex(
    season: Union[int, str],
    season_type: Union[int, str],
    week: Union[int, str],
    ...
    **kwargs,
    ...
    Example URL: https://sports.core.api.espn.com/v2/sports/soccer/leagues/fifa.world/seasons/2024/types/2/weeks/8/powerindex

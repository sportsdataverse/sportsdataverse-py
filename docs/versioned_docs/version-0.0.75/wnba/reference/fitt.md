...
`sportsdataverse.wnba` — 1 endpoint.

## `espn_wnba_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/wnba/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/wnba/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/wnba/powerindex?season=2024)

...
`sportsdataverse.nwsl` — 1 endpoint.

## `espn_nwsl_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/usa.nwsl/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/usa.nwsl/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/usa.nwsl/powerindex?season=2024)

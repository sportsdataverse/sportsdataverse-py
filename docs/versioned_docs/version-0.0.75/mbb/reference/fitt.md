...
`sportsdataverse.mbb` — 1 endpoint.

## `espn_mbb_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/mens-college-basketball/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/mens-college-basketball/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/basketball/mens-college-basketball/powerindex?season=2024)

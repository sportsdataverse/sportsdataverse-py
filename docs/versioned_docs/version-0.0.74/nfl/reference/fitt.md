...
`sportsdataverse.nfl` — 1 endpoint.

## `espn_nfl_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/football/nfl/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/football/nfl/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/football/nfl/powerindex?season=2024)

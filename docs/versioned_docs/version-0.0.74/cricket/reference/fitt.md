...
`sportsdataverse.cricket` — 1 endpoint.

## `espn_cricket_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/cricket/eng.1/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/cricket/eng.1/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/cricket/eng.1/powerindex?season=2024)

...
`sportsdataverse.mlb` — 1 endpoint.

## `espn_mlb_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/mlb/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/mlb/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/mlb/powerindex?season=2024)

...
| [Dataset loaders](reference/loaders) | 37 | sportsdataverse raw data / sportsdataverse-data releases |
| [Additional functions](reference/additional) | 74 | hand-written wrappers, loaders & helpers |

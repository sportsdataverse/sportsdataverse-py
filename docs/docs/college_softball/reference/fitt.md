...
`sportsdataverse.college_softball` — 1 endpoint.

## `espn_college_softball_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-softball/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-softball/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-softball/powerindex?season=2024)

...
`sportsdataverse.ligue1` — 5 endpoints.

## `espn_ligue1_player_overview`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/{athlete_id}/overview`

**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/overview](https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/overview)
...
```python
espn_ligue1_player_overview(athlete_id='4239')
```

_Last validated n/a._

## `espn_ligue1_player_stats`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/{athlete_id}/stats`

**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/stats](https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/stats)
...
```python
espn_ligue1_player_stats(athlete_id='4239')
```

_Last validated n/a._

## `espn_ligue1_player_gamelog`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/{athlete_id}/gamelog`

**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/gamelog](https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/gamelog)
...
```python
espn_ligue1_player_gamelog(athlete_id='4239')
```

_Last validated n/a._

## `espn_ligue1_player_splits`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/{athlete_id}/splits`

**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/splits](https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/athletes/4239/splits)
...
```python
espn_ligue1_player_splits(athlete_id='4239')
```
...
**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/statistics/byathlete](https://site.web.api.espn.com/apis/common/v3/sports/soccer/fra.1/statistics/byathlete)

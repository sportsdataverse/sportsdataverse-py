...
`sportsdataverse.uel` — 24 endpoints.
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/scoreboard?dates=20240115](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/scoreboard?dates=20240115)
...
```python
espn_uel_scoreboard(dates='20240115')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/summary](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/summary)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/calendar](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/calendar)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/news](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/news)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/injuries](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/injuries)
...
## `espn_uel_transactions`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/transactions`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/transactions](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/transactions)
...
## `espn_uel_conferences`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/groups`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/groups](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/groups)
...
## `espn_uel_statistics_league`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/statistics`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/statistics](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/statistics)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/draft](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/draft)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4)
...
```python
espn_uel_team(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_roster`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/roster`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/roster](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/roster)
...
```python
espn_uel_team_roster(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_schedule`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/schedule`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/schedule](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/schedule)
...
```python
espn_uel_team_schedule(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_record`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/record`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/record](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/record)
...
```python
espn_uel_team_record(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_depthcharts`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/depthcharts`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/depthcharts](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/depthcharts)
...
```python
espn_uel_team_depthcharts(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_injuries`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/injuries`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/injuries](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/injuries)
...
```python
espn_uel_team_injuries(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_transactions`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/transactions`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/transactions](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/transactions)
...
```python
espn_uel_team_transactions(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_history`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/history`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/history](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/history)
...
```python
espn_uel_team_history(team_id='4')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/news](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/news)
...
```python
espn_uel_team_news(team_id='4')
```

_Last validated n/a._

## `espn_uel_team_leaders`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/{team_id}/leaders`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/leaders](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/teams/4/leaders)
...
```python
espn_uel_team_leaders(team_id='4')
```

_Last validated n/a._

## `espn_uel_player_info`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/{athlete_id}`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239)
...
```python
espn_uel_player_info(athlete_id='4239')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239/bio](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239/bio)
...
```python
espn_uel_player_bio(athlete_id='4239')
```

_Last validated n/a._

## `espn_uel_player_news`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/{athlete_id}/news`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239/news](https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.europa/athletes/4239/news)
...
```python
espn_uel_player_news(athlete_id='4239')
```
...
**Valid URL:** [https://site.api.espn.com/apis/v2/sports/soccer/uefa.europa/standings](https://site.api.espn.com/apis/v2/sports/soccer/uefa.europa/standings)

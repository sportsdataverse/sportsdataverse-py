...
## `espn_nba_season_week_powerindex`
...
**Valid URL:** [https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/2024/types/2/weeks/8/powerindex](https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/2024/types/2/weeks/8/powerindex)
...
```python
espn_nba_season_week_powerindex(season=2024, season_type=2, week=8)
```

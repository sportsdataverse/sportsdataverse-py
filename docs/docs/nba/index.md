...
### sportsdataverse.nba.nba_game_rosters.espn_nba_game_rosters(game_id: int, raw=False, return_as_pandas=True, \*\*kwargs)
...
### sportsdataverse.nba.nba_loaders.load_nba_pbp(seasons: List[int], return_as_pandas=True)
...
### sportsdataverse.nba.nba_loaders.load_nba_player_boxscore(seasons: List[int], return_as_pandas=True)
...
### sportsdataverse.nba.nba_loaders.load_nba_schedule(seasons: List[int], return_as_pandas=True)
...
### sportsdataverse.nba.nba_loaders.load_nba_team_boxscore(seasons: List[int], return_as_pandas=True)
...
### sportsdataverse.nba.nba_schedule.espn_nba_calendar(season=None, ondays=None, return_as_pandas=True, \*\*kwargs)
...
### sportsdataverse.nba.nba_schedule.espn_nba_schedule(dates=None, season_type=None, limit=500, return_as_pandas=True, \*\*kwargs)
...
### sportsdataverse.nba.nba_teams.espn_nba_teams(return_as_pandas=True, \*\*kwargs)

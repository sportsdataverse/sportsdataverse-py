...
| [Dataset loaders](reference/loaders) | 11 | nflverse data releases / sportsdataverse-data releases |
| [Additional functions](reference/additional) | 175 | hand-written wrappers, loaders & helpers |

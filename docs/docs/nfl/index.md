...
| [Additional functions](reference/additional) | 101 | hand-written wrappers, loaders & helpers |
...
| [`load_nfl_depth_charts`](reference/additional#load_nfl_depth_charts) | [`load_depth_charts`](https://nflreadr.nflverse.com/reference/load_depth_charts.html) |
...
| [`load_nfl_ftn_charting`](reference/additional#load_nfl_ftn_charting) | [`load_ftn_charting`](https://nflreadr.nflverse.com/reference/load_ftn_charting.html) |
| [`load_nfl_injuries`](reference/additional#load_nfl_injuries) | [`load_injuries`](https://nflreadr.nflverse.com/reference/load_injuries.html) |
...
| [`load_nfl_pbp`](reference/additional#load_nfl_pbp) | [`load_pbp`](https://nflreadr.nflverse.com/reference/load_pbp.html) |
| [`load_nfl_pbp_participation`](reference/additional#load_nfl_pbp_participation) | [`load_participation`](https://nflreadr.nflverse.com/reference/load_participation.html) |
...
| [`load_nfl_rosters`](reference/additional#load_nfl_rosters) | [`load_rosters`](https://nflreadr.nflverse.com/reference/load_rosters.html) |
...
| [`load_nfl_snap_counts`](reference/additional#load_nfl_snap_counts) | [`load_snap_counts`](https://nflreadr.nflverse.com/reference/load_snap_counts.html) |
...
| [`load_nfl_weekly_rosters`](reference/additional#load_nfl_weekly_rosters) | [`load_rosters_weekly`](https://nflreadr.nflverse.com/reference/load_rosters_weekly.html) |

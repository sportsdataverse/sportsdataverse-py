...
`sportsdataverse.nhl` — 82 endpoints.
...
**Endpoint URL:** `GET https://sports.core.api.espn.com/v2/sports/hockey/leagues/nhl/coaches`

**Valid URL:** [https://sports.core.api.espn.com/v2/sports/hockey/leagues/nhl/coaches](https://sports.core.api.espn.com/v2/sports/hockey/leagues/nhl/coaches)

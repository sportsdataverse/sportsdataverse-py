...
| [nhl api web](reference/nhl_api_web) | 27 | `https://api-web.nhle.com` |
| [nhl edge](reference/nhl_edge) | 35 | `https://api-web.nhle.com` |
| [nhl stats rest](reference/nhl_stats_rest) | 21 | `https://api.nhle.com/stats/rest` |
| [nhl records](reference/nhl_records) | 44 | `https://records.nhl.com/site/api` |

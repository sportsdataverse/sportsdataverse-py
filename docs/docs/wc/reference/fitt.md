...
`sportsdataverse.wc` — 1 endpoint.

## `espn_wc_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/fifa.world/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/fifa.world/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/soccer/fifa.world/powerindex?season=2024)

...
`sportsdataverse.xfl` — 1 endpoint.

## `espn_xfl_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/football/xfl/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/football/xfl/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/football/xfl/powerindex?season=2024)

...
`sportsdataverse.xfl` — 24 endpoints.
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/scoreboard?dates=20240115](https://site.api.espn.com/apis/site/v2/sports/football/xfl/scoreboard?dates=20240115)
...
```python
espn_xfl_scoreboard(dates='20240115')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/summary](https://site.api.espn.com/apis/site/v2/sports/football/xfl/summary)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/calendar](https://site.api.espn.com/apis/site/v2/sports/football/xfl/calendar)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/news](https://site.api.espn.com/apis/site/v2/sports/football/xfl/news)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/injuries](https://site.api.espn.com/apis/site/v2/sports/football/xfl/injuries)
...
## `espn_xfl_transactions`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/transactions`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/transactions](https://site.api.espn.com/apis/site/v2/sports/football/xfl/transactions)
...
## `espn_xfl_conferences`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/groups`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/groups](https://site.api.espn.com/apis/site/v2/sports/football/xfl/groups)
...
## `espn_xfl_statistics_league`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/statistics`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/statistics](https://site.api.espn.com/apis/site/v2/sports/football/xfl/statistics)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/draft](https://site.api.espn.com/apis/site/v2/sports/football/xfl/draft)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams)
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4)
...
```python
espn_xfl_team(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_roster`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/roster`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/roster](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/roster)
...
```python
espn_xfl_team_roster(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_schedule`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/schedule`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/schedule](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/schedule)
...
```python
espn_xfl_team_schedule(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_record`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/record`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/record](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/record)
...
```python
espn_xfl_team_record(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_depthcharts`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/depthcharts`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/depthcharts](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/depthcharts)
...
```python
espn_xfl_team_depthcharts(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_injuries`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/injuries`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/injuries](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/injuries)
...
```python
espn_xfl_team_injuries(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_transactions`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/transactions`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/transactions](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/transactions)
...
```python
espn_xfl_team_transactions(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_history`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/history`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/history](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/history)
...
```python
espn_xfl_team_history(team_id='4')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/news](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/news)
...
```python
espn_xfl_team_news(team_id='4')
```

_Last validated n/a._

## `espn_xfl_team_leaders`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/leaders`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/leaders](https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/4/leaders)
...
```python
espn_xfl_team_leaders(team_id='4')
```

_Last validated n/a._

## `espn_xfl_player_info`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/{athlete_id}`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239](https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239)
...
```python
espn_xfl_player_info(athlete_id='4239')
```
...
**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239/bio](https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239/bio)
...
```python
espn_xfl_player_bio(athlete_id='4239')
```

_Last validated n/a._

## `espn_xfl_player_news`

ESPN endpoint.

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/{athlete_id}/news`

**Valid URL:** [https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239/news](https://site.api.espn.com/apis/site/v2/sports/football/xfl/athletes/4239/news)
...
```python
espn_xfl_player_news(athlete_id='4239')
```
...
**Valid URL:** [https://site.api.espn.com/apis/v2/sports/football/xfl/standings](https://site.api.espn.com/apis/v2/sports/football/xfl/standings)

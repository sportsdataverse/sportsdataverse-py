...
`sportsdataverse.college_baseball` — 1 endpoint.

## `espn_college_baseball_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-baseball/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-baseball/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/baseball/college-baseball/powerindex?season=2024)

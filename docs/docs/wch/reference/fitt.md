...
`sportsdataverse.wch` — 1 endpoint.

## `espn_wch_fpi`

ESPN endpoint.

**Endpoint URL:** `GET https://site.web.api.espn.com/apis/fitt/v3/sports/hockey/womens-college-hockey/powerindex`

**Valid URL:** [https://site.web.api.espn.com/apis/fitt/v3/sports/hockey/womens-college-hockey/powerindex?season=2024](https://site.web.api.espn.com/apis/fitt/v3/sports/hockey/womens-college-hockey/powerindex?season=2024)

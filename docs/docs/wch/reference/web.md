...
`sportsdataverse.wch` — 5 endpoints.

## `espn_wch_player_overview`
...
**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/overview](https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/overview)
...
```python
espn_wch_player_overview(athlete_id='4239')
```

_Last validated n/a._

## `espn_wch_player_stats`
...
**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/stats](https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/stats)
...
```python
espn_wch_player_stats(athlete_id='4239')
```

_Last validated n/a._

## `espn_wch_player_gamelog`
...
**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/gamelog](https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/gamelog)
...
```python
espn_wch_player_gamelog(athlete_id='4239')
```

_Last validated n/a._

## `espn_wch_player_splits`
...
**Valid URL:** [https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/splits](https://site.web.api.espn.com/apis/common/v3/sports/hockey/womens-college-hockey/athletes/4239/splits)
...
```python
espn_wch_player_splits(athlete_id='4239')
```

...
```
    ...
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Seahawks    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ betus       ┆ h2h        ┆ New England ┆ null        ┆ 163         │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Patriots    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ betus       ┆ h2h        ┆ Seattle     ┆ null        ┆ -190        │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Seahawks    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ betus       ┆ spreads    ┆ New England ┆ 3.5         ┆ -110        │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Patriots    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ betus       ┆ spreads    ┆ Seattle     ┆ -3.5        ┆ -110        │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Seahawks    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ fanduel     ┆ h2h        ┆ New England ┆ null        ┆ 184         │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Patriots    ┆             ┆             │
    │ Seattle      ┆ New England  ┆ fanduel     ┆ h2h        ┆ Seattle     ┆ null        ┆ -220        │
    │ Seahawks     ┆ Patriots     ┆             ┆            ┆ Seahawks    ┆             ┆             │
    └──────────────┴──────────────┴─────────────┴────────────┴─────────────┴─────────────┴─────────────┘
...
```
    ...
    │ San Francisco 49ers  ┆ Arizona Cardinals ┆ Arizona Cardinals ┆ 440        ┆ draftkings     │
    │ San Francisco 49ers  ┆ Miami Dolphins    ┆ Miami Dolphins    ┆ 410        ┆ draftkings     │
...
```
    ...
    │ Seahawks    ┆ Patriots          ┆            ┆                   ┆               ┆               │
    │ Los Angeles ┆ San Francisco     ┆ spreads    ┆ Los Angeles Rams  ┆ -3.5          ┆ -105          │
    │ Rams        ┆ 49ers             ┆            ┆                   ┆               ┆               │
    │ Los Angeles ┆ San Francisco     ┆ spreads    ┆ San Francisco     ┆ 3.5           ┆ -115          │
    │ Rams        ┆ 49ers             ┆            ┆ 49ers             ┆               ┆               │
...
```
    ...
    │ Los Angeles Rams    ┆ San Francisco 49ers  ┆ betonlineag    ┆ 1.032265     ┆ 3.23     │
    │ Los Angeles Rams    ┆ San Francisco 49ers  ┆ lowvig         ┆ 1.032265     ┆ 3.23     │
    │ Las Vegas Raiders   ┆ Miami Dolphins       ┆ betonlineag    ┆ 1.032265     ┆ 3.23     │
    │ Las Vegas Raiders   ┆ Miami Dolphins       ┆ lowvig         ┆ 1.032265     ┆ 3.23     │
    │ Seattle Seahawks    ┆ New England Patriots ┆ lowvig         ┆ 1.032531     ┆ 3.25     │
    │ Seattle Seahawks    ┆ New England Patriots ┆ betonlineag    ┆ 1.032531     ┆ 3.25     │
...
```
    ...
    │ str                  ┆ str               ┆ str                  ┆ i64           ┆ str           │
    ╞══════════════════════╪═══════════════════╪══════════════════════╪═══════════════╪═══════════════╡
    │ Los Angeles Chargers ┆ Arizona Cardinals ┆ Los Angeles Chargers ┆ -725          ┆ mybookieag    │
    │ Los Angeles Chargers ┆ Arizona Cardinals ┆ Los Angeles Chargers ┆ -650          ┆ betmgm        │
    │ Los Angeles Chargers ┆ Arizona Cardinals ┆ Los Angeles Chargers ┆ -625          ┆ draftkings    │
    │ Los Angeles Chargers ┆ Arizona Cardinals ┆ Los Angeles Chargers ┆ -600          ┆ lowvig        │
    │ Los Angeles Chargers ┆ Arizona Cardinals ┆ Los Angeles Chargers ┆ -600          ┆ betonlineag   │
    └──────────────────────┴───────────────────┴──────────────────────┴───────────────┴───────────────┘
...
```
    ...
    │ Cincinnati Bengals    ┆ Tampa Bay Buccaneers  ┆ 52.0            ┆ 11      │
    │ Dallas Cowboys        ┆ Washington Commanders ┆ 51.5            ┆ 3       │
    │ Cincinnati Bengals    ┆ Jacksonville Jaguars  ┆ 51.5            ┆ 3       │
    │ Dallas Cowboys        ┆ Baltimore Ravens      ┆ 51.0            ┆ 5       │
    │ Buffalo Bills         ┆ New England Patriots  ┆ 50.0            ┆ 2       │
    │ Detroit Lions         ┆ New Orleans Saints    ┆ 49.5            ┆ 11      │
    │ Washington Commanders ┆ Indianapolis Colts    ┆ 49.5            ┆ 4       │

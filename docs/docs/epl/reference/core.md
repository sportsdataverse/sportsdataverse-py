...
`sportsdataverse.epl` — 82 endpoints.
...
## `espn_epl_season_week_powerindex`

ESPN endpoint.

**Endpoint URL:** `GET https://sports.core.api.espn.com/v2/sports/soccer/leagues/eng.1/seasons/{season}/types/{season_type}/weeks/{week}/powerindex`

**Valid URL:** [https://sports.core.api.espn.com/v2/sports/soccer/leagues/eng.1/seasons/2024/types/2/weeks/8/powerindex](https://sports.core.api.espn.com/v2/sports/soccer/leagues/eng.1/seasons/2024/types/2/weeks/8/powerindex)
...
```python
espn_epl_season_week_powerindex(season=2024, season_type=2, week=8)
```

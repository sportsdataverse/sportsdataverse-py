...
`sportsdataverse.epl` — 24 endpoints.
...
```python
espn_epl_scoreboard(dates='20240115')
```
...
```python
espn_epl_team(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_roster`
...
```python
espn_epl_team_roster(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_schedule`
...
```python
espn_epl_team_schedule(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_record`
...
```python
espn_epl_team_record(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_depthcharts`
...
```python
espn_epl_team_depthcharts(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_injuries`
...
```python
espn_epl_team_injuries(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_transactions`
...
```python
espn_epl_team_transactions(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_history`
...
```python
espn_epl_team_history(team_id='4')
```
...
```python
espn_epl_team_news(team_id='4')
```

_Last validated n/a._

## `espn_epl_team_leaders`
...
```python
espn_epl_team_leaders(team_id='4')
```

_Last validated n/a._

## `espn_epl_player_info`
...
```python
espn_epl_player_info(athlete_id='4239')
```
...
```python
espn_epl_player_bio(athlete_id='4239')
```

_Last validated n/a._

## `espn_epl_player_news`
...
```python
espn_epl_player_news(athlete_id='4239')
```

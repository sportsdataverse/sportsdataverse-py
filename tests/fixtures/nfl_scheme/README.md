...
| `fg_attempts_2019_2023.parquet` | same pipeline, `play_type == "field_goal"` — the **held-out** FG calibration oracle (ENVIRONMENT_FG_COEF is fit on 2010–2018 only) | 2019–2023 | 5321 x 42 |
| `schedule_2021_2023.parquet` | `load_nfl_schedule` (`game_id`, `season`, `total_line`) — market totals for the expected-plays gate | 2021–2023 | 854 x 3 |

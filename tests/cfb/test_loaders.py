...
class TestLoadCfbPbp:
    ...
    def test_load_cfb_pbp_invalid_season(self):
        ...
        with pytest.raises(
            SeasonNotFoundError, match="season cannot be less than 2003"
        ):
...
class TestLoadCfbSchedule:
    ...
    def test_load_cfb_schedule_invalid_season(self):
        ...
        with pytest.raises(
            SeasonNotFoundError, match="season cannot be less than 2002"
        ):
...
class TestLoadCfbRosters:
    ...
    def test_load_cfb_rosters_invalid_season(self):
        ...
        with pytest.raises(
            SeasonNotFoundError, match="season cannot be less than 2004"
        ):

...
def getEspnPbp():
    ...
    print('espn_cfb_pbp() - Pull the game by id. Data from API endpoints: college-football/playbyplay, college-football/summary')
...
def loadEspnMbbPbp():
     ...
     print('mbb_pbp() - Pull the game by id. Data from API endpoints: mens-college-basketball/playbyplay, mens-college-basketball/summary')
...
def loadEspnWbbPbp():
    ...
    print('espn_wbb_pbp() - Pull the game by id. Data from API endpoints - womens-college-basketball/playbyplay, womens-college-basketball/summary')

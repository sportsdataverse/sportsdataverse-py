...
def getEspnSchedule():
    print(
        "sportsdataverse.cfb.espn_cfb_schedule(dates=2020, week=5, season_type=2, groups=80)"
    )
    ...
    espnSchedule = sportsdataverse.cfb.espn_cfb_schedule(
        dates=2020, week=5, season_type=2, groups=80
    )
    print(espnSchedule)
...
def loadCfbRosters():
    ...
    loadedCfbRosters = cfb_df = sportsdataverse.cfb.load_cfb_rosters(
        seasons=range(2014, 2010)
    )
...
def loadCfbTeamInfo():
    ...
    loadedCfbTeamInfo = cfb_df = sportsdataverse.cfb.load_cfb_team_info(
        seasons=range(2009, 2010)
    )
...
def loadMbbPlayerBoxscore():
    ...
    mbbPlayerBoxscore = sportsdataverse.mbb.load_mbb_player_boxscore(
...
def loadMbbTeamBoxscore():
    ...
    mbbTeamBoxscore = sportsdataverse.mbb.load_mbb_team_boxscore(
...
def loadEspnMbbSchedule():
    ...
    espnMbbSchedule = sportsdataverse.mbb.espn_mbb_schedule(
        dates=2020, groups=50, season_type=2
    )
...
def loadNbaPlayerBoxscores():
    ...
    nbaBoxscore = sportsdataverse.nba.load_nba_player_boxscore(
        seasons=range(2020, 2022)
    )
    print(nbaBoxscore)
...
def loadNbaTeamBoxscores():
    ...
    nbaTeamBoxscores = sportsdataverse.nba.load_nba_team_boxscore(
        seasons=range(2020, 2022)
    )
...
def loadEspnNbaCalendar():
    ...
    print(
        "sportsdataverse.nba.espn_nba_schedule(dates=range(2020,2022), season_type=2)"
    )
    espnNbaCalendar = sportsdataverse.nba.espn_nba_schedule(
        dates=range(2020, 2022), season_type=2
    )
...
def loadEspnNflSchedule():
    ...
    espnNflSchedule = sportsdataverse.nfl.espn_nfl_schedule(
        dates=2020, week=1, season_type=2
    )
...
def loadWbbPlayerBoxscores():
    ...
    wbbPlayerBoxscore = sportsdataverse.wbb.load_wbb_player_boxscore(
        seasons=range(2020, 2022)
    )
...
def loadWbbTeamBoxscores():
    ...
    wbbTeamBoxscores = sportsdataverse.wbb.load_wbb_team_boxscore(
        seasons=range(2020, 2022)
    )
...
def loadEspnWbbSchedule():
    ...
    espnWbbSchedule = sportsdataverse.wbb.espn_wbb_schedule(
        dates=2020, groups=50, season_type=2
    )
...
def loadWnbaPlayerBoxscores():
    ...
    wnbaPlayerBoxscore = sportsdataverse.wnba.load_wnba_player_boxscore(
        seasons=range(2020, 2022)
    )
...
def loadWnbaTeamBoxscores():
    ...
    wnbaTeamBoxscores = sportsdataverse.wnba.load_wnba_team_boxscore(
        seasons=range(2020, 2022)
    )
...
def loadEspnWnbaSchedule():
    ...
    espnWnbaSchedule = sportsdataverse.wnba.espn_wnba_schedule(
        dates=2020, season_type=2
    )

...
"text","type.text","fg_kicker_player_name","yds_fg",
"fg_attempt", "fg_made",
"fg_return_player_name", "fg_block_player_name",
"kickoff_player_name","yds_kickoff",
"kickoff_return_player_name", "yds_kickoff_return",
"punt_return_player_name","yds_punt_return",
"punter_player_name","yds_punted",
"punt_block_player_name","yds_punt_gained"
]]
    print(special_teams)
